...
void HashTable::SaveTable(FILE *f) { SaveTable(f, 0, HASH_SIZE, true); }

void HashTable::SaveTable(FILE *f, uint32_t from, uint32_t to,
                          bool printPoint) {
...
void HashTable::LoadTable(FILE *f) { LoadTable(f, 0, HASH_SIZE); }
